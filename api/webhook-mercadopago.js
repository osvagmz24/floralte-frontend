...
function whatsappParam(value, max = 900) {
  return String(value ?? "")
    .replace(/[\r\n\t]+/g, " ")
    .replace(/\s{2,}/g, " ")
    .trim()
    ...
    return graphPost(phoneNumberId, token, {
      ...
      template: {
        ...
        components: [{
          type: "body",
          parameters: [
  { type: "text", text: whatsappParam(reference, 90) },
  { type: "text", text: whatsappParam(total, 90) },
  { type: "text", text: whatsappParam(customer, 100) },
  { type: "text", text: whatsappParam(summary, 900) }
